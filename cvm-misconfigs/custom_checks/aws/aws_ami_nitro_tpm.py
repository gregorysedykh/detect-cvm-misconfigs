...
class AWSAMINitroTPM(BaseResourceCheck):
    def __init__(self) -> None:
        name = "Ensure AWS instance enforces NitroTPM via lifecycle precondition"
        id = "AWSAMINitroTPM"
    ...
    def scan_resource_conf(self, conf: dict) -> CheckResult:
        ...
        for pc in preconditions:
            ...
            if "tpm_support" in str(condition):
                return CheckResult.PASSED

        return CheckResult.FAILED


check = AWSAMINitroTPM()
